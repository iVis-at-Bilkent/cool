...
$("body").on("change", "#file-input", function (e) {
    ...
    console.log( "fileeeeeeeeeeeeeeeeeeeeeeeeee changed");
...
$("#sample0").click(function (e) {
    ...
    loadSample("sample1-simple-json");
});
$("#sample1").click(function (e) {
    loadSample("sample2-simple-json");
});
$("#sample2").click(function (e) {
    loadSample("sample3-simple-json");
});
